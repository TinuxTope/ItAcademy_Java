...
db.restaurants.find({"$or": [{"cuisine": "Seafood", "cuisine": { "$nin": ["American", "Chinese"] }}, {"name": { "$regex": "^Wil" }}]}, { "restaurant_id": 1, "name": 1, "borough": 1, "cuisine": 1 })
...
db.restaurants.find({"address.coord.1": { "$gt": 42, "$lte": 52 } }, { "restaurant_id": 1, "name": 1, "address": 1, "address.coord": 1 })
